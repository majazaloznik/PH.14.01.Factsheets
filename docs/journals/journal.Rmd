...
coud be used to restore these attributes.`

6. Actually `subset` was not dropping labells, or rather it only did so because I changed the variable names. Changing them later fixes that. 

7. Rerun the `02-clean.R` on everything.. 

8. Did installing r3.4 ruin all my other package installations? of course it did.

9. OK, `lodown` seems my first solution was the way to go afterall, but no worries, a learned a tonne and it was fun. 
