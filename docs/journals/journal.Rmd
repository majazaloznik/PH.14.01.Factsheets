...
Also all of a sudden there was a problem with the `dglogo.eps` file with os2pdf not liking it and throwing an error about 9.15: Unrecoverable error, exit code 1 undefinedresource. I only know it was that file through elimination. But I swapped it for another copy and it seems fine now.. 
